...
import { DoorOpen, Sun, Moon, Sparkles, Lock, Mail } from 'lucide-react';
      ...
      <main className="flex-1 flex items-center justify-center px-4 py-8">
        ...
        >
          ...
          <div className="flex flex-col items-center mb-6 text-center">
            <div className={`p-3 rounded-2xl mb-3 ${isLight ? 'bg-[#ff9500]/10' : 'bg-white/[0.06]'}`}>
              <DoorOpen size={32} className="text-[#ff9500]" />
            </div>
          ...
          <p className={`text-center text-sm mt-5 ${isLight ? 'text-[#86868b]' : 'text-white/40'}`}>
            New here?{' '}
            <Link to="/register" className="font-semibold text-[#ff9500] hover:underline">
              Create an account
            </Link>
          </p>
        </motion.div>
